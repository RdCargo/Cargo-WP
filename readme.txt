...
* Fix automatic shipment create to apply settings

== 5.3.3 ==
* Fix bulk shipments create to count settings

== 5.4.0 ==
* Add filter for from/to addresses to allow modifications of custom fields
